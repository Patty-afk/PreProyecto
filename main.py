...
#agregue opciones al menu
    ...
    if opcion == "4":
        ...
        animal = Animal(tipo_animal=tipo, nombre=nombre, especie=especie, fecha_llegada=fecha_llegada,
                        fecha_nacimiento=fecha_nacimiento, peso=peso, frecuecia_alimentacion=frecuencia_alimentacion, cuenta_vacunas=vacunas)
